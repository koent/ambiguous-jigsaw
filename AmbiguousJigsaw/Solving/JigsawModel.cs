...
using AmbiguousJigsaw.Solving.Constraints;

namespace AmbiguousJigsaw.Solving;

public class JigsawModel : Model
{
    ...
    public JigsawModel(InputData inputData) : this(inputData.Height, inputData.Width, inputData.VerticalEdges, inputData.HorizontalEdges) { }

    public JigsawModel(int height, int width, int[,] verticalEdges, int[,] horizontalEdges)
    {
