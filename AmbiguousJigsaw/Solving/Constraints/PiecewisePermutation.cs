...
using PiecewiseUnequalPropagator = AmbiguousJigsaw.Solving.Propagators.PiecewiseUnequal;
using PiecewisePermutationPropagator = AmbiguousJigsaw.Solving.Propagators.PiecewisePermutation;

namespace AmbiguousJigsaw.Solving.Constraints;
